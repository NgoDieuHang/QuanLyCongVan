/*
 * Các xử lý cho hiển thị danh sách slide
...
function InitalizeSlides() {
    try {
        ...
        jMessage(0, function (ok) {
        }, '<b>InitalizeSlides:</b> ' + e.message, 4);
    }
}
/*
...
function InitEventSlides() {
    try {
        ...
        jMessage(0, function (ok) {
        }, '<b>InitEventSlides:</b> ' + e.message, 4);
    }
}
/*
...
/*
 * Cập nhật trạng thái hiên thị của slide lên server
 * Author       :   QuyPN - 09/07/2018 - create
 * Param        :   
 * Output       :   
 */
function UpdateShowSlide(element) {
    try {
        ...
        jMessage(0, function (ok) {
        }, '<b>UpdateShowSlide:</b> ' + e.message, 4);
    }
}
/*

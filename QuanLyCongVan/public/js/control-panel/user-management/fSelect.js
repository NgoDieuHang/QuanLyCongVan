(function($) {
    ...
    $.fn.fSelect = function(options) {
        ...
        if ('string' === typeof options) {
            ...
            var lang = getLang();
            if (lang === 'vi') {
                var placeholder = 'Chọn tên nhóm';
                var searchText = 'Tìm kiếm';
                var noResultsText = 'Không tìm thấy kết quả';
                var overflowText = 'đã chọn';
            } else {
                var placeholder = 'Select some options';
                var searchText = 'Search';
                var noResultsText = 'No results found';
                var overflowText = 'selected';
            }
            var settings = $.extend({
                placeholder: placeholder,
                numDisplayed: 3,
                overflowText: '{n} ' + overflowText,
        ...
        fSelect.prototype = {
            create: function() {
                ...
                this.$select.wrap('<div class="fs-wrap' + multiple + '"style="margin-left:0%; margin-top:0%" />');
